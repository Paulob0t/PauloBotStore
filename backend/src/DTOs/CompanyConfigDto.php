...
#[OA\Schema(
    schema: "CompanyConfigDto",
    title: "Configuración de Empresa y Ticket",
...
class CompanyConfigDto
{
    ...
    #[OA\Property(property: "mensaje_ticket", type: "string", nullable: true, example: "¡GRACIAS POR SU COMPRA! VUELVA PRONTO")]
