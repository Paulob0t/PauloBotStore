<?php
/**
 * 🚀 API OPTIMIZADA - Carga todo de una vez
 * Reduce múltiples peticiones HTTP a una sola
 */
...
try {
    // 1️⃣ CATEGORÍAS + SUBCATEGORÍAS (1 query con JOIN)
    $sql_categories = "
        SELECT 
            c.id_categoria, 
            c.nombre_categoria, 
    ...
    // 2️⃣ TODOS LOS PRODUCTOS (1 query optimizada)
    $sql_products = "
        SELECT 
            id_producto, 
            id_categoria, 
