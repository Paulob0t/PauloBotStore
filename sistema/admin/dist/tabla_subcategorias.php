                ...
                <div class="card-body">
                  <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
                    ...
                    <div class="d-flex align-items-center gap-2" style="min-width: 320px;">
                      ...
                      <button id="guardar_titulo_subcategorias" type="button" class="btn btn-outline-success btn-sm" title="Guardar título">
                        <i class="fa fa-save"></i>
                      </button>
                    </div>

                    <button class="btn btn-success" id="btnAgregarSubcategoria">
                      <i class="fa fa-plus"></i> Agregar Subcategoría
                    </button>
                  </div>
                  <div class="table-responsive">
                    <table class="table table-striped table-borderless" id="subcategoriasTable">
                      <thead>
                        <tr>
                          <th>Categoría</th>
                          <th>Subcategoría</th>
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form id="formAgregarSubcategoria">
                    ...
                    <div class="form-group mb-3">
                      <label for="add_imagen_subcategoria" class="form-label">
                        <i class="mdi mdi-image-outline me-1"></i>Imagen de la Subcategoría
                      </label>
                      <input type="file" class="form-control" name="imagen_subcategoria" id="add_imagen_subcategoria"
                        accept="image/*">
                      <input type="hidden" name="imagen_base64" id="add_imagen_base64">
                      <div class="mt-2">
                        <img id="add_imagen_preview" src="#" alt="Preview" style="max-width: 200px; display: none;"
              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form id="formEditarSubcategoria">
                    ...
                    <div class="form-group mb-3">
                      <label for="edit_imagen_subcategoria" class="form-label">
                        <i class="mdi mdi-image-outline me-1"></i>Imagen de la Subcategoría
                      </label>
                      <input type="file" class="form-control" name="imagen_subcategoria" id="edit_imagen_subcategoria"
                        accept="image/*">
                      <input type="hidden" name="imagen_base64" id="edit_imagen_base64">
                      <div class="mt-2">
                        <img id="edit_imagen_preview" src="#" alt="Preview" style="max-width: 200px; display: none;"
                          class="img-fluid rounded">
                      </div>
                    </div>
                  </form>
