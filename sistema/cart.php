...
<body class="cart-page">
                                ...
                                <div class="mb-3 p-2 rounded-3" style="background: rgba(246,218,1,0.05); border: 1px solid rgba(246,218,1,0.2);">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <span id="cash-received-label" style="font-size: 0.85rem; color: rgba(255,255,255,0.6);">
                                            <i class="bi bi-wallet2 me-1"></i>Ingresado
                                        </span>
    ...
    <script>
        ...
        window.renderProductCards = function() {
                ...
                // ✅ VALIDAR que Cart y Cart.items existen
                ...
                // 🔥 USAR Cart.items directamente (ya tiene getter que devuelve array vacío si no hay datos)
                ...
                // Actualizar hero
                if (heroCount) heroCount.textContent = `${cart.length} item${cart.length !== 1 ? 's' : ''}`;
...
const cartItems = Cart.items;
            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                if (typeof Cart !== 'undefined') {
                    try {
                        ...
                        // ⏱️ ESPERAR UN FRAME para asegurar que Cart.items esté listo
                        requestAnimationFrame(() => {
                            // ✅ VALIDAR que Cart.items existe
                            const itemCount = (Cart.items && Array.isArray(Cart.items)) ? Cart.items.length : 0;
                            ...
                            setTimeout(() => {
                                const currentCount = (Cart.items && Array.isArray(Cart.items)) ? Cart.items.length : 0;
                                if (currentCount > 0) {
                        ...
                        const verificacionInterval = setInterval(() => {
                            ...
                            const itemsEnCarrito = Cart.items?.length || 0;
            ...
            // 💰 CALCULADORA VISUAL DE EFECTIVO (SIN MONEDERO)
