...
if (!isset($conn) || !$conn) {
    $flash = ['type' => 'error', 'text' => 'No se pudo cargar la conexión de debug_bd.'];
}
        ...
        <div class="hero">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="meta">
                        <div class="pill">Base de datos<strong>colegos_Ecosystem</strong></div>
                        <div class="pill">Usuario<strong>colegos_admin</strong></div>
                        <div class="pill">Charset<strong>utf8mb4</strong></div>
                        <div class="pill">Ruta<strong>/debug_bd/</strong></div>
                    </div>
                </div>
            </div>
            <div class="card">
