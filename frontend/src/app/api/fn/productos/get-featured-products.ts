...
export function getFeaturedProducts(http: HttpClient, rootUrl: string, params?: GetFeaturedProducts$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<ProductDto>>> {
